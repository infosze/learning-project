...
import static hu.ak_akademia.cf.club_members.v2.SortKey.*;
import static hu.ak_akademia.cf.club_members.v2.Grade.*;
...
public class Main {
	...
	void test() {
		Members members = new Members(GRADE_ENROLLMENTDATE);
		...
		members.add(person4);
		members.add(person5);
//		members.setSortKey(BIRTHDATE_LASTNAME);
		members.add(person6);
		members.add(person7);
		members.add(person8);
		members.add(person9);
